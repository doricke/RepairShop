...
main ()
{
  ...
  while ( fof.eof != TRUE )
  {
    ...
    if ( name2 [ stridx ( name2, "." ) ] == '.' )

      name2 [ stridx ( name2, "." ) ] = 'x';

    while ( name2 [ stridx ( name2, "x0" ) ] == 'x' )
    {
      index = stridx ( name2, "x0" ) + 1;
      strcpy ( &(name2 [ index ]), &(name2 [ index + 1 ]) );
    }  /* while */
    ...
    if ( name2 [ strlen ( name2 ) - 1 ] == 'b' )
    {
      name2 [ strlen ( name2 ) - 1 ] = '\0';
      strcat ( name2, "f2" );
    }  /* if */

    if ( name2 [ strlen ( name2 ) - 1 ] == 'c' )
    {
      name2 [ strlen ( name2 ) - 1 ] = '\0';
      strcat ( name2, "f3" );
    }  /* if */

    if ( name2 [ strlen ( name2 ) - 1 ] == 'd' )
    {
      name2 [ strlen ( name2 ) - 1 ] = '\0';
      strcat ( name2, "f4" );
    }  /* if */

    if ( name2 [ strlen ( name2 ) - 1 ] == 'e' )
    {
      name2 [ strlen ( name2 ) - 1 ] = '\0';
      strcat ( name2, "f5" );
    }  /* if */

    if ( name2 [ strlen ( name2 ) - 1 ] == 'f' )
    {
      name2 [ strlen ( name2 ) - 1 ] = '\0';
      strcat ( name2, "f6" );
    }  /* if */

    if ( name2 [ strlen ( name2 ) - 1 ] == 'x' )
    {
      name2 [ strlen ( name2 ) - 1 ] = '\0';
      strcat ( name2, "f9" );
    }  /* if */

    if ( name2 [ stridx ( name2, "f" ) ] == '\0' )
