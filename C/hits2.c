...
*/
#define AMINO_ACIDS     393     /* Number of amino acids in p53 */
#define F_SPACERS      0.60     /* Fraction of spacers in p53 */
...
est_hits ( years, rate )
int    years;    /* million of years of divergence */
float  rate;     /* mutation rate per million years */
{
