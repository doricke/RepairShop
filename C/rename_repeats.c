...
main ()
{
  ...
  printf ( "This is the Repeat Results Renaming program.\n\n" );
  ...
  while ( fof.eof != TRUE )
  {
    ...
    if ( name2 [ stridx ( name2, "BK" ) ] == 'B' )
      name2 [ stridx ( name2, "BK" ) + 1 ] = 'B';

    if ( name2 [ stridx ( name2, "BR" ) ] == 'B' )
      name2 [ stridx ( name2, "BR" ) + 1 ] = 'A';

    if ( name2 [ stridx ( name2, "FK" ) ] == 'F' )
      name2 [ stridx ( name2, "FK" ) + 1 ] = 'B';

    if ( name2 [ stridx ( name2, "FR" ) ] == 'F' )
      name2 [ stridx ( name2, "FR" ) + 1 ] = 'A';
