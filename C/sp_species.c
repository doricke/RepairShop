...
main ()
{
  ...
  char    line [ MAX_LINE ];		/* current .dat file line */
  char    taxonomy [ MAX_LINE * 5 ];	/* species taxonomy names */


  /* Initialization. */
  accession [ 0 ] = taxonomy [ 0 ] = '\0';

  printf ( "This is the SwissProt species program.\n\n" );

  /* Prompt for the input file name. */
  prompt_file ( &sp, "What is the name of the SwissProt .dat file?" );

  d_strcpy ( species.name, sp.name );
