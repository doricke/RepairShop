...
#define MAX_PER_LINE    10      /* maximum species names per line */
#define MAX_SPECIES     1500    /* maximum number of species per gene */
...
main ( )
{
  ...
  while ( ( status == S_NORMAL ) || ( status == S_EOL ) )
  {
    ...
    if ( strcmp ( next_species, "felca" ) == 0 )  animals++;
    ...
    if ( strcmp ( next_species, "brare" ) == 0 )  animals++;
    if ( strcmp ( next_species, "carau" ) == 0 )  animals++;
    if ( strcmp ( next_species, "chick" ) == 0 )  animals++;
    if ( strcmp ( next_species, "crigr" ) == 0 )  animals++;
    if ( strcmp ( next_species, "macfa" ) == 0 )  animals++;
    if ( strcmp ( next_species, "mesau" ) == 0 )  animals++;
    if ( strcmp ( next_species, "oncmy" ) == 0 )  animals++;
    if ( strcmp ( next_species, "ranca" ) == 0 )  animals++;
    if ( strcmp ( next_species, "xenla" ) == 0 )  animals++;
