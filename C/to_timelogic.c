...
main ()
{
  ...
  while ( fof.eof != TRUE )
  {
    ...
    fprintf ( cmds.data, "dc_new_target " );
    fprintf ( cmds.data, "-source %s ", name );
    fprintf ( cmds.data, "-template nt_all " );
    fprintf ( cmds.data, "-targ %s ", name );
    fprintf ( cmds.data, "-desc \"TMRI confidential: %s\" ", name );
    fprintf ( cmds.data, "-mach paragon" );
    fprintf ( cmds.data, "\n" );
