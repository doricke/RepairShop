...
/*******************************************************************************/
  public void matchConsensus ()
  {
    ...
    Digest digest = new Digest ();		// Trypsin digest of sequence
    digest.setSequence ( bests [ 0 ].getSequence () );
    ...
    for ( int i = 0; i < length; i++ )
    {
      ...
      if ( i < msa [ 0 ].length () )
      {
             ...
             ( ( letter >= 'A' ) && ( letter <= 'Z' ) ) )
        {
          ...
          System.out.println ( count + "\t" + cons.getCount () + "\t" + percent + "%" );

          // Set the sequence percent identity for this residue
          digest.setIdentity ( residue-1, percent );
        }  // if
      }  // if
    ...
    System.out.println ( Html.htmlTag ( Html.html ) );
    System.out.println ( Html.htmlTag ( Html.head ) );
    System.out.println ( Html.htmlEndTag ( Html.head ) );
    System.out.println ( Html.htmlTag ( Html.body ) );
    digest.colorSequence ();
    System.out.println ( Html.htmlTag ( Html.pre ) );
    System.out.println ( Html.htmlTag ( Html.tt ) );
    digest.digestSequence ();
    System.out.println ( Html.htmlTag ( Html.br ) );

    // Print out the low identity residues.
    residue = 0;
    for ( int i = 0; i < msa [ 0 ].length (); i++ )
    {
      ...
      if ( ( ( letter >= 'a' ) && ( letter <= 'z' ) ) ||
           ( ( letter >= 'A' ) && ( letter <= 'Z' ) ) )
      {
        percent = digest.getIdentity ( residue );
        residue++;
        if ( percent < 40 )
          System.out.println ( residue + "\t" + letter + "\t" + percent );
      }  // if
    }  // for

    System.out.println ( Html.htmlEndTag ( Html.tt ) );
    System.out.println ( Html.htmlEndTag ( Html.pre ) );
    System.out.println ( Html.htmlEndTag ( Html.body ) );
    System.out.println ( Html.htmlEndTag ( Html.html ) );
