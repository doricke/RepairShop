...
public class BlastParserOne extends Object
{
...
/******************************************************************************/
public BlastParserOne ()
{
  initialize ();
}  // constructor BlastParserOne
...
/******************************************************************************/
  private void usage ()
  {
    ...
    System.out.println ();
    System.out.println ( "java BlastParserOne <BLAST_file>" );
    System.out.println ();
    System.out.print   ( "where <Blast_file> is the file name of a " );
    System.out.println ( "BLAST output." );
  }  // method usage
...
/******************************************************************************/
  ...
  {
    BlastParserOne app = new BlastParserOne ();
