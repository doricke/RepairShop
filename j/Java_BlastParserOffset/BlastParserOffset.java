...
public class BlastParserOffset extends Object
{
...
/******************************************************************************/
public BlastParserOffset ()
{
  initialize ();
}  // constructor BlastParserOffset
...
/******************************************************************************/
  private void addAlignment ( Hit hit, BlastHeader blast_header )
  {
         ...
         ( hit.getIdentities () > Alignment.MIN_AA_SEGMENT_IDENTITIES ) )
    {
      ...
      hits_file.println ( hit.toResult ( blast_header.getDatabaseName (), blast_header.getStartOffset () ) );
    }  // if
    else
    {
      hit.initialize ();
...
/******************************************************************************/
  private void usage ()
  {
    ...
    System.out.println ();
    System.out.println ( "java BlastParserOffset <list_of_BLAST_files>" );
    System.out.println ();
...
/******************************************************************************/
  ...
  {
    BlastParserOffset app = new BlastParserOffset ();
