...
final static private int MAX_PROTEINS = 20000;
  ...
  public void processQueryFile ( String file_name )
  {
    ...
    while ( fasta_file.isEndOfFile () == false )
    {
      ...
      if ( fasta_sequence.getLength () > 0 )
      {
        ...
        family_files [ total ].print ( fasta_sequence.toString () );
...
*/
          ...
          if ( ( count >= 30 ) && ( query_percent >= min_identity ) && ( target_percent >= min_identity ) )  
          {
            ...
            family_files [ i ].print ( fasta_sequence.toString () );
          }  // if
        }  // for
...
/******************************************************************************/
  private void usage ()
  {
    ...
    System.out.println ();
    System.out.println ( "java EvoSearch <query.fasta> <file.list> <minimum identity>" );
    System.out.println ();
...
/******************************************************************************/
  public static void main ( String [] args )
  {
    ...
    {
      int min_identity = 30;		// 12% identity minimum
