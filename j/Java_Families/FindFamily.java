...
public class FindFamily extends Object
{


/******************************************************************************/

private static final int MIN_LENGTH = 50;		// Minimum protein length
...
/******************************************************************************/
  public void processFastaFiles ( String file_name )
  {
    FastaIterator fasta_file = new FastaIterator ( file_name );
    ...
    while ( fasta_file.isEndOfFile () == false )
    {
      ...
      // Add the FASTA sequence to the protein families.
      if ( fasta_sequence.getLength () >= MIN_LENGTH )
...
/******************************************************************************/
  private void usage ()
  {
    ...
    System.out.println ();
    System.out.println ( "java FindFamily <file.list>" );
    System.out.println ();
