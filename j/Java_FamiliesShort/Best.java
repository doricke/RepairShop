...
/******************************************************************************/
  ...
  private   short  common_words = 0;		// common amino acid words

  private   int  family = 0;			// protein family

  private   String  sequence_name = "";		// sequence name

  private   short  super_family = 0;		// super-family
...
/******************************************************************************/
  public short [] getShortWords ()
  {
    return words.getWords ();
  }  // method getShortWords
...
/******************************************************************************/
  public void setCommonWords ( short value )
  {
    common_words = value;
...
/******************************************************************************/
  public void setSuperFamily ( short value )
  {
    super_family = value;
...
/******************************************************************************/
  private void computeWords ( FastaSequence fasta_sequence )
  {
    ...
    words.setSize ( (short) ( length - WORD_SIZE + 1 ) );
