...
/******************************************************************************/
  ...
  private final static int MAX_PROTEINS = 100000;
...
/******************************************************************************/
  private void findBest ( Best next )
  {
    ...
    if ( total <= 0 )
    {
      ...
      next.setSuperFamily ( (short) super_families );	// Set the protein super family number
      return;
    }  // if
    ...
    for ( int i = 0; i < total; i++ )
    {
      ...
      int count = words.countCommonWords ( best [ i ].getShortWords () );
    ...
    next.setCommonWords ( (short) best_count ); 
    ...
    if ( best_count > 9 )
    {
      ...
      if ( best_count > 49 )
      {
        ...
        {
          best [ best_match ].setCommonWords ( (short) best_count );
