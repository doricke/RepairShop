...
public class FindFastaSSRs extends Object
{

/******************************************************************************/

private FastaIterator dna_file = new FastaIterator ();	// DNA input file

private FastaSequence fasta_sequence = null;		// FASTA sequence


/******************************************************************************/
public FindFastaSSRs ()
{
  initialize ();
}  // constructor FindFastaSSRs
  ...
  private void findSSRs ( String dna_seq )
  {
    ...
    do 
    {
      ...
      if ( ssr_start != -1 )
      {
        ...
        System.out.print ( fasta_sequence.getName () + "\t" + ssr_start 
            + "\t" + pattern + "\t(" + pattern + ")" 
            + (length / 2) + "\t" );
...
/******************************************************************************/
  public void processFile ( String file_name )
  {
    ...
    do
    {
      fasta_sequence = dna_file.next ();
      // fasta_sequence.setSequenceType ( Sequence.DNA );

      // Check the DNA for Simple Sequence Repeats.
      findSSRs ( fasta_sequence.getSequence () );
    }
...
/******************************************************************************/
  private void usage ()
  {
    ...
    System.out.println ();
    System.out.println ( "java FindFastaSSRs <genomic fasta filename>" );
    System.out.println ();
    System.out.print   ( "where <genomic fasta filename> is the file name of a " );
    System.out.println ( "genomic FASTA sequence file." );
  }  // method usage
...
/******************************************************************************/
  ...
  {
    FindFastaSSRs app = new FindFastaSSRs ();
