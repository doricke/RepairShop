...
public class FindDnaSSRs extends Object
{
...
/******************************************************************************/
  private void usage ()
  {
    ...
    System.out.println ();
    System.out.println ( "java FindDnaSSRs <DNA FASTA file>" );
    System.out.println ();
    System.out.print   ( "where <DNA FASTA file> is the file name of a " );
    System.out.println ( "FASTA file of DNA sequences." );
  }  // method usage
...
/******************************************************************************/
  ...
  {
    FindDnaSSRs app = new FindGenomicSSRs ();
