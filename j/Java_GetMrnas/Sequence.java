...
private StringBuffer description = new StringBuffer ( 4096 );	// sequence description

private StringBuffer header_line = new StringBuffer ( 4096 );	// header line
...
private final static char [] complement = {
...
*/
{
 String sBases     = "ACGTUMRWSKYVHDBXNacgtumrwskyvhdbxn.-";

 //                 A   C   G   T   U   M   R   W   S   K   Y   V   H   D   B   X   N
 char []adsBase = {'T','G','C','A','A','K','Y','W','S','M','R','B','D','H','V','X','N',
                   't','g','c','a','a','k','y','w','s','m','r','b','d','h','v','x','n','.','-'
                  };    //Complement to Bases string
