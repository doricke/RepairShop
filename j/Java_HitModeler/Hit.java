...
/******************************************************************************/
  ...
  private   int     query_sequence_id = 0;		// query sequence id 
  ...
  private   boolean  selected = false;			// select hit flag
...
/******************************************************************************/
  public void setQuerySequenceId ( int value )
  {
...
/******************************************************************************/
  public String toResult ( String database_name )
  {
    ...
    result.append ( "\t" );
    result.append ( query_start );			// query start
    result.append ( "\t" );
    result.append ( query_end );			// query end
    result.append ( "\t" );
