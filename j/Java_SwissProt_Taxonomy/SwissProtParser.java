...
// private Sequence seq = new Sequence();			// Sequence object
...
/******************************************************************************/
  private void parseSequence ()
  {
    ...
    // writeSequence ( aa_sequence.toString () );
...
/******************************************************************************/
  public void processFile ()
  {
    ...
    while ( swissprot_file.isEndOfFile () != true )
    {
      ...
      organelle = swissprot_header.getOrganelle ();

      if ( ( organelle.equals ( "Chloroplast" ) == true ) || 
           ( organelle.equals ( "Mitochondrion" ) == true ) )
        System.out.println ( swissprot_header.getAccession () + "\t" + organelle );
      else
        if ( swissprot_header.getKingdom ().equals ( "Eukaryota" ) == false )
        {
          // System.out.println ( swissprot_header.getAccession () + "\t" + swissprot_header.getKingdom () );
          System.out.println ( swissprot_header.getIdName () + "\t" + swissprot_header.getKingdom () );
        }  // if
    }  // while
...
/******************************************************************************/
  private void usage ()
  {
    ...
    System.out.println ( "SwissProt AA sequence file." );
  }  // method usage
