...
/******************************************************************************/
  ...
  InputTools input_file = new InputTools ();		// Input file

  String output_file_name = "";				// Output file name

  OutputTools output_file = new OutputTools ();		// Output file
...
/******************************************************************************/
  private void usage ()
  {
    System.out.println ( "This program generates a new Java class shell template." );
    System.out.println ();
    System.out.println ( "The command line syntax for this program is:" );
    System.out.println ();
    System.out.println ( "java NewClass <input_file> <output_file>" );
    System.out.println ();
    System.out.println ( "where <input_file> is the file containing lines:" );
    System.out.println ();
    System.out.println ( "<Java type> <variable name>" );
  }  // method usage
