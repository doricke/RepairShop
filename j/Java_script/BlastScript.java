...
public class BlastScript extends Object
{
...
/******************************************************************************/
  ...
  private  String  database_name = "Myriad_V8";	// Database name to search against

  private  String  directory_path = "";		// Directory path

  private  InputTools  list_file = new InputTools ();	// Input file

  private  int first_node = 17;			// First node to use

  private  int last_node = first_node + 7;	// Last node to use

  private  String  program_name = "tblastn";	// BLAST program name
...
/******************************************************************************/
  private void processFile ()
  {
    ...
    cmds [ 0 ].println ( "mkdir /bio" + directory_path + program_name );
...
/******************************************************************************/
  ...
  {
    BlastScript app = new BlastScript ();
