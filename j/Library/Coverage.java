...
/******************************************************************************/
public class Coverage extends Frame
{
    ...
    while ( end_of_file == false )
    {
      try
      {
        ...
        else
        {
          ...
          lengthHistograms.addToHistograms ( clear );
...
public static void main ( String [] args )
{
  ...
  if ( args.length == 0 )
  {
    readFrame = new Coverage ();
    readFrame.resize ( 300, 300 );
    readFrame.setTitle ( "Coverage" );
  ...
  else
  {
    ...
    fileName = args [ 0 ];
    Coverage readLens = new Coverage ();
