...
/******************************************************************************/
public class GetAceSeqs extends Frame
{
...
public static void main ( String [] args )
{
  ...
  if ( args [ 0 ].length () == 0 )
  {
    aceFrame = new GetAceSeqs ();
    aceFrame.resize ( 300, 300 );
    aceFrame.setTitle ( "GetAceSeqs .ace file DNA Sequence extractor" );
  ...
  {
    fileName = args [ 0 ];
    GetAceSeqs readSeqs = new GetAceSeqs ();
