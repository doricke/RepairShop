...
/******************************************************************************/
  public void write_XML_field ( String name, int name_value )
  {
    spacing ();
    xml_file.print ( "<Field name=\"" + name + "\">" + name_value );
    xml_file.println ( "</Field>" );
...
{
  write_XML_entry_end ();		// Document
  write_XML_entry_end ();		// Folder
  write_XML_entry_end ();		// User
}  // method endDocument


/******************************************************************************/
public void startDocument ( Parameters parameters )
{
  if ( parameters == null )
  {
    System.out.println ( "No parameters file in startDocument." );
    return;
  }  // if

  // Check if Document specified.
  if ( parameters.getDocumentId () > 0 )
  {
    write_XML_entry ( "User" );
    write_XML_field ( "user_name", parameters.getUserName () );

    write_XML_entry ( "Folder" );
    // write_XML_field ( "folder_id", parameters.getFolderId () );
    write_XML_field ( "folder_name", parameters.getFolderName () );
    write_XML_field ( "lower_folder_name", 
        parameters.getFolderName ().toLowerCase () );

    write_XML_entry ( "Document" );
    // write_XML_field ( "document_id", parameters.getDocumentId () );
    write_XML_field ( "document_name", parameters.getDocumentName () );
    write_XML_field ( "lower_document_name", 
        parameters.getDocumentName ().toLowerCase () );
  }  // if
...
/******************************************************************************/
  public static void main ( String [] args )
  {
    ...
    app.write_XML_field ( "clone_name", "BCD" );
